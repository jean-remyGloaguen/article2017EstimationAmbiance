...
\nomenclature{$\mathbf{H_s}$}{Activation matrix for $\mathbf{W_s}$}
\nomenclature{$\mathbf{H_r}$}{Activation matrix for $\mathbf{W_r}$}
...
The dataset supporting the conclusions of this article is available in the \textit{urban$\_$traffic$\_$nmf$\_$dataset.zip}  repository, \url{https://zenodo.org/record/1145855#.Wl2oPnkiGos}. 
The software supporting the conclusions of this article is available in 

\begin{itemize}
\item Project name: article2017EstimationAmbiance
\item Project home page: \url{https://github.com/jean-remyGloaguen/article2017EstimationAmbiance}
