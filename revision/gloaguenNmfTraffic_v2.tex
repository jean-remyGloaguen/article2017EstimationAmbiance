...
The aim is to find the type of NMF that gives the minimal error on the estimation of the traffic noise signal level on the whole corpus.% to be applied to all the different possible urban noise environments.
...
For each couple of methods, the $H_0$ hypothesis is rejected meaning that the distributions of the sound level estimations according to the approaches are significantly different despite similar mean errors.
